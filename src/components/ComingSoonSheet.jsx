...
function ComingSoonSheet({ message, onClose, title = 'Coming soon' }) {
  if (!message) {
    return null
  }
  ...
  return (
    <div className="fixed inset-0 z-20 flex items-end bg-stone-900/25 px-4 pb-4">
      <div className="mx-auto w-full max-w-[430px] rounded-3xl bg-[#FAF8F3] p-4 shadow-[0_18px_50px_rgba(30,41,59,0.25)]">
        ...
        <p className="mt-4 rounded-2xl bg-[#F8F2EA] px-4 py-3 text-sm font-semibold leading-relaxed text-stone-500">
          {message}
        </p>
      </div>
    </div>
